...
app.post(properties.api + '/Users/:id', function (req, res) {
	...
	db_PowerCLILaunch_db.User.findByIdAndUpdate(req.params.id, user, {
		'new': true
	}, function (err, obj) {
...
app['post'](properties.api + '/Users/:id/changePassword', function (req, res) {
	...
	db_PowerCLILaunch_db.User.findOne({
		...
		db_PowerCLILaunch_db.User.findByIdAndUpdate(req.params.id, {
